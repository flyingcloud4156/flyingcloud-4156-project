...
public class CategoryController {
    ...
    public Result<CategoryResponse> createCategory(@PathVariable Long ledgerId, @Valid @RequestBody CreateCategoryRequest req) {
        return Result.ok(categoryService.createCategory(ledgerId, req));
    }

    @GetMapping
    @Operation(summary = "List categories")
    public Result<ListCategoriesResponse> listCategories(@PathVariable Long ledgerId, @RequestParam(required = false) Boolean active) {
