...
# =======================================================================================
# API TEST: EXPENSE TRANSACTION (WEIGHTED SPLIT)
# =======================================================================================
#
# SCENARIO:
...
echo_subtitle "1.3 Creating 'Dinner Club' Ledger"
ledger_payload=$(jq -n --arg name "Dinner Club" '{name:$name, ledger_type:"GROUP_BALANCE", base_currency:"USD"}')
...
echo "Payload: Alice pays 100, split by weight (Alice:2, Bob:1, Charlie:1)"
