...
# =======================================================================================
# API TEST: EXPENSE TRANSACTION (PERCENT SPLIT) - VERBOSE MODE
# =======================================================================================
#
# SCENARIO:
#   - Ledger: "Investment Club" (ID: 1), GROUP_BALANCE
#   - Users: Alice (ID: 1), Bob (ID: 2), Charlie (ID: 3)
#   - Action: Alice pays $1000 for a group investment.
#   - Split: PERCENT split. Alice (50%), Bob (30%), Charlie (20%).
#
# EXPECTED OUTCOME:
#   - Transaction: A $1000 EXPENSE transaction is created.
#   - Splits: Alice's share is $500, Bob's is $300, Charlie's is $200.
#   - Debt Edges: Bob owes Alice $300, Charlie owes Alice $200.
#
# =======================================================================================
...
echo_subtitle "1.5 Creating 'Investment Club' Ledger"
ledger_payload=$(jq -n --arg name "Investment Club" '{
    "name": $name,
...
echo "[OK] Ledger 'Investment Club' created with ID: $LEDGER_ID"
...
# =======================================================================================
echo_title "2. CREATING EXPENSE TRANSACTION (PERCENT SPLIT)"

echo "Alice pays \$1000 for investment, split by percentage:"
echo "  - Alice: 50% → expects \$500.00"
echo "  - Bob:   30% → expects \$300.00"
echo "  - Charlie: 20% → expects \$200.00"
echo "  - Total: 100%"
echo ""
...
echo "Expected computed amounts: Alice=\$500.00, Bob=\$300.00, Charlie=\$200.00"
...
echo "  - Charlie owes Alice \$200.00 (from_user_id=Alice, to_user_id=Charlie)"
echo ""
...
echo ""
echo "Summary:"
echo "  - Alice paid \$1000, her share is \$500 (50%)"
echo "  - Bob owes Alice \$300 (30%)"
echo "  - Charlie owes Alice \$200 (20%)"
echo "  - Total debt to Alice: \$500 (matches her overpayment)"