...
# =======================================================================================
# API TEST: EXPENSE TRANSACTION (WEIGHTED SPLIT) - VERBOSE MODE
# =======================================================================================
#
# SCENARIO:
#   - Ledger: "Dinner Club" (ID: 1), GROUP_BALANCE
#   - Users: Alice (ID: 1), Bob (ID: 2), Charlie (ID: 3)
#   - Action: Alice pays $100 for dinner.
#   - Split: WEIGHTED split. Alice (weight 2), Bob (weight 1), Charlie (weight 1).
#
# EXPECTED OUTCOME:
#   - Transaction: A $100 EXPENSE transaction is created.
#   - Splits: Alice's share is $50, Bob's is $25, Charlie's is $25.
#   - Debt Edges: Bob owes Alice $25, Charlie owes Alice $25.
#
# =======================================================================================
...
echo_subtitle "1.5 Creating 'Dinner Club' Ledger"
ledger_payload=$(jq -n --arg name "Dinner Club" '{
    "name": $name,
...
echo "✅ Ledger 'Dinner Club' created with ID: $LEDGER_ID"
...
# =======================================================================================
echo_title "2. CREATING EXPENSE TRANSACTION (WEIGHTED SPLIT)"

echo "Alice pays \$100 for dinner, split by weight:"
echo "  - Alice: weight 2 → expects \$50.00"
echo "  - Bob:   weight 1 → expects \$25.00"
echo "  - Charlie: weight 1 → expects \$25.00"
echo ""
...
payload=$(jq -n \
    ...
    --arg note "Dinner at fancy restaurant" \
...
echo "Expected computed amounts: Alice=\$50.00, Bob=\$25.00, Charlie=\$25.00"
...
echo "  - Bob owes Alice \$25.00 (from_user_id=Alice, to_user_id=Bob)"
...
echo ""
echo "Summary:"
echo "  - Alice paid \$100, her share is \$50"
echo "  - Bob owes Alice \$25"
echo "  - Charlie owes Alice \$25"
echo "  - Total debt to Alice: \$50 (matches her overpayment)"
